        ...
        <form method="post" action="{{ url('/register') }}" class="form-horizontal">
            ...
            <div class="row" style="margin-top: 10px;">
                <div class="col-sm-offset-2 col-sm-9">
                    <button type="submit" class="btn btn-primary btn-block btn-flat"><i class="fa fa-user-plus" aria-hidden="true"></i> 注 册</button>
                </div>
            </div>
        </form>
        <div class="row login-box-bottom">
            <div class="col-sm-offset-2 col-sm-9">
                <a href="{{ url('/login') }}" class="text-center">已有账号，直接登陆</a>
            </div>
        </div>
    </div>
    <!-- /.login-box-body -->
